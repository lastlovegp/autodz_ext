...
namespace MdTZ
{
    ...
    class Strategy_Sel_Ext 
    {
        public static void gp_sel_process()
        {
            ...
            double zhengf = 0;
            double sum_zhengf = 0;
            double pj_6_zhengfu = 0;
            double pj_12_zhengfu = 0;
            double pj_24_zhengfu = 0;
            double pj_30_zhengfu = 0;
            double pj_60_zhengfu = 0;
            ...
            foreach (DailyBar bar in barList)
            {
                ...
                foreach (DailyBar c_bar in last70Bars)
                {
                    ...
                    else if (idx == 6)
                    {
                        ...
                        pj_6_zhengfu = Math.Round(sum_zhengf / idx, 2);
                    }
                    else if (idx == 7)
                    {
                        zf_sum_7 = sum_zf;                       
                    ...
                    else if (idx == 12)
                    {
                        ...
                        pj_12_zhengfu = Math.Round(sum_zhengf / idx, 2);
                    }                   
                    else if (idx == 20)
                    {
                    ...
                    else if (idx == 24)
                    {
                        ...
                        pj_24_zhengfu = Math.Round(sum_zhengf / idx, 2);
                    }
                    ...
                    else if (idx == 30)
                    {
                        ...
                        zf_sum_30 = sum_zf;
                        pj_30_zhengfu = Math.Round(sum_zhengf / idx, 2);
                        sum_30_amt = sum_amt;

                        top_30_price = Math.Round(highest_price, 2);                       
                    }
                    else if (idx == 60)
                    {
                        ...
                        pj_60_zhengfu = Math.Round(sum_zhengf / idx, 2);
                ...
                {                   
                    updSql.Append("UPDATE gpzfrec SET zr_close=")
                        ...
                        .Append(",pj_6_zhengfu=")
                        .Append(pj_6_zhengfu)
                        .Append(",pj_12_zhengfu=")
                        .Append(pj_12_zhengfu)
                        .Append(",pj_24_zhengfu=")
                        .Append(pj_24_zhengfu)
                        .Append(",pj_30_zhengfu=")
                        .Append(pj_30_zhengfu)
                        .Append(",pj_60_zhengfu=")
                        .Append(pj_60_zhengfu)
                        .Append(",tp_bar_num=")
                        .Append(tp_bar_num)
                        .Append(",last_tp_open=")
