...
namespace Baidu.Aip.Demo
{
    class SpeechDemo
    {
        ...
        public SpeechDemo()
        {
            _asrClient = new Asr("VWXpqPVIH1NbGkp7pojoRUXG", "Cmjkfx7Lxs2RdAc72TOtY2MFwIta8w5p ");
            _ttsClient = new Tts("VWXpqPVIH1NbGkp7pojoRUXG", "Cmjkfx7Lxs2RdAc72TOtY2MFwIta8w5p ");
        }
