...
public class ExcelTemplate {
	...
	public void parse(HttpServletRequest request) {
		...
		if(SysUtils.isEmpty(templatePath)){
			log.error(SysConstants.Exception_Head + "Excel模板路径不能为空!");
		}
		...
		if(SysUtils.isEmpty(is)){
			log.error(SysConstants.Exception_Head + "未找到模板文件,请确认模板路径是否正确[" + templatePath + "]");
		}
