package com.base.common.bean.impl;
...
import com.erp.framework.util.TypeCaseHelper;
import com.erp.framework.util.XmlHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(SysConstants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(SysConstants.XML_Node))
			// 节点元素值风格
