...
public class ExtXmlHelper {
	private static Log log = LogFactory.getLog(ExtXmlHelper.class);
	...
	public static final Dto parseXml2DtoBasedNode(String pStrXml) {
		...
		try {
			...
			log.error("将XML格式的字符串转换为XML DOM对象时发生错误啦!" + "\n详细错误信息如下:");
			e.printStackTrace();
		}
		// 获取根节炄1�7
		Element elNode = document.getRootElement();
		// 遍历节点属�1�7��1�7�将其压入Dto
	 ...
	 *            待解析的XML字符丄1�7
	 * @param pXPath
	 *            节点路径(例如＄1�7"//paralist/row" 则表示根节点paralist下的row节点的xPath路径)
	 * @return outDto 返回Dto
	 */
	...
	/**
	 * 解析XML并将其节点元素压入Dto返回(基于属�1�7��1�7�形式的XML格式)
	 * 
	 * @param pStrXml
	 *            待解析的XML字符丄1�7
	 * @param pXPath
	...
	/**
	 * 将Dto转换为符合XML标准规范格式的字符串(基于节点值形弄1�7)
	 * 
	 * @param dto
	 *            传入的Dto对象
	 * @param pRootNodeName
	 *            根结点名
	 * @return string 返回XML格式字符丄1�7
	 */
	...
	/**
	 * 将Dto转换为符合XML标准规范格式的字符串(基于属�1�7��1�7�形弄1�7)
	 * 
	 * @param pDto
	 *            传入的Dto对象
	 * @param pRootNodeName
	...
	/**
	 * 将List数据类型转换为符合XML格式规范的字符串(基于节点属�1�7��1�7�的方式)
	 * 
	 * @param pList
	...
	/**
	 * 将XML规范的字符串转为List对象(XML基于节点属�1�7��1�7�的方式)
	 * 
	 * @param pStrXml
	 *            传入的符合XML格式规范的字符串
