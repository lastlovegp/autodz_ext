...
public class GetCsvDataFromYahoo {
	...
	public static ArrayList getStockCsvData(String stockName, int T)
			throws Exception {
	...
	public static String getStockTodayData(String stockName) throws Exception {
		...
		String url = YAHOO_FINANCE_URL_TODAY + "s=" + stockName
				+ "&f=d1ohgl1vl1";
	...
	public static GetCsvDataFromYahoo createObject(String line) {
	...
	public static void main(String args[]) throws Exception {
		...
		ArrayList list = GetCsvDataFromYahoo.getStockCsvData("600000.ss", 10);
