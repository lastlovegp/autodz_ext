...
public class CryptionData {
	...
	public static String getFristEnData() throws Exception {
		CryptionData data = new CryptionData(NetworkInfo.getMacAddress());
		return data.EncryptionStringData(DateUtil.dateToString(DateUtil
				.getCurrentDate()));
	}
