...
public class SysUtils {
	...
	public static String getBizTitle(String biztype) {
		String title = "";
		if (biztype.equals(SysConstants.ORDER_TYPE_BUY_ORDER)) {
			title = "采购订单";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_BUY_BILL)) {
			title = "采购单";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_BUY_BACK_BILL)) {
			title = "采购退货";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_SELL_ORDER)) {
			title = "销售订单";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_SELL_BILL)) {
			title = "销售单";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_SELL_BACK_BILL)) {
			title = "销售退货";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_OTHER_IN_STORE)) {
			title = "其他入库单";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_OTHER_OUT_STORE)) {
			title = "其他出库单";
		} else if (biztype.equals(SysConstants.ORDER_TYPE_LEAVE_APPLY)) {
			title = "请假单";
		}
		return title;
	}
