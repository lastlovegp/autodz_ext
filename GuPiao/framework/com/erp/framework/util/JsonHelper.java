...
public class JsonHelper {
	...
	public static final String encodeObject2Json(Object pObject) {
		return encodeObject2Json(pObject, SysConstants.FORMAT_Date);
	}
	...
	public static final String encodeList2FormJson(Object obj, String dateFormat) {
		String subJsonString = "";
		if (DataFormat.isEmpty(dateFormat)) {
			dateFormat = SysConstants.FORMAT_DateTime;
		}
		if (SysUtils.isEmpty(dateFormat)) {
			subJsonString = encodeObject2Json(obj);
		} else {
			subJsonString = encodeObject2Json(obj, dateFormat);
		}
		String jsonString = "{success:true, data:" + subJsonString + "}";
		return jsonString;
	}
	...
	private static String encodeJson2PageJson(String jsonString,
			Integer totalCount) {
		jsonString = "{totalCount:" + totalCount + ", items:" + jsonString
				+ "}";
		if (log.isInfoEnabled()) {
	...
	public static final String encodeTouchJson(Object obj, String dateFormat) {
		String subJsonString = "";
		if (DataFormat.isEmpty(dateFormat)) {
			dateFormat = SysConstants.FORMAT_DateTime;
		}
	...
	public static final String encodeList2PageJson(List list,
			Integer totalCount, String dateFormat) {
		String subJsonString = "";
		if (DataFormat.isEmpty(dateFormat)) {
			dateFormat = SysConstants.FORMAT_DateTime;
		}
		if (SysUtils.isEmpty(dateFormat)) {
			...
			subJsonString = encodeObject2Json(list, dateFormat);
		}
		String jsonString = "{totalCount:" + totalCount + ", items:"
				+ subJsonString + "}";
		return jsonString;
	}

	public static final String encodeSetPageJson(Set list, Integer totalCount,
			String dateFormat) {

		List dataList = new ArrayList();
		dataList.addAll(list);

		return encodeList2PageJson(dataList, totalCount, dateFormat);
	}

	public static final String encodeObject2FormJson(Object obj, String dateFormat) {
		String subJsonString = "";
		if (DataFormat.isEmpty(dateFormat)) {
			dateFormat = SysConstants.FORMAT_DateTime;
		}
	...
	public static Dto parseSingleJson2Dto(String jsonString) {
		Dto dto = new BaseDto();
		if (SysUtils.isEmpty(jsonString)) {
			return dto;
		}
