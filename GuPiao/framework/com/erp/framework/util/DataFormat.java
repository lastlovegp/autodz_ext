...
public class DataFormat {
	...
	private static final String DATE_YEAR_MONTH = "yyMM";
	private static final String DATE_YEAR_MONTH_EXT = "yyyyMM";

	private static final String DATE_NUMBER_PATTERN = "yyyyMMdd";
	public static final String DATE_EXT_PATTERN = "yy年MM月dd日";
	...
	private static final String FUNCCODE_PATTERN = "00";
	 ...
	 * @return
	 */
	public static String dateToYearMont4(Date date) {
		if (date == null)
			return null;

		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
				DataFormat.DATE_YEAR_MONTH);
		return simpleDateFormat.format(date);
	}
	 ...
	 * @return
	 */
	public static String dateToYearMont6(Date date) {
		if (date == null)
			return null;

		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
				DataFormat.DATE_YEAR_MONTH_EXT);
		return simpleDateFormat.format(date);
	}
	...
	public static String toFuncCodeFormat(int funcCode) {
		DecimalFormat decimalFormat = new DecimalFormat(
				DataFormat.FUNCCODE_PATTERN);
		return decimalFormat.format(funcCode);
	}
	...
	/**
	 * 将YYYYMM格式的期限转换为n年n月n日的汉字描述
	 * 
	 * @param term
	 * @return
	 */
	public static String termToDateStr(String term) {
		String years = term.substring(0, 4);
		String months = term.substring(4, 6);
		return years + "-" + months + "-01";
	}

	public static String DescToDate(String term) {
		return term.replaceAll("年", "-").replaceAll("月", "-")
				.replaceAll("日", "-");
	}
	...
	public static void main(String[] a) {
		Double discount = new Double(9);
		Double price = new Double(5.6);
